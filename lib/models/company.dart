...
class Company{
  ...
  Company({this.companyName, this.job, this.city, this.sallary, this.image, this.mainCriteria, this.jobOpportunity, this.aboutCompany, this.jobResponsbilities, this.tag});
